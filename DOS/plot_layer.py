...
x,y,z = np.loadtxt('aldos.data', unpack = True, usecols= (0,1,2))
x_new = (-31.96828 + x*0.06344 )*0.529177
...
vmin = 0.0
vmax = 0.5
scatter = plt.scatter(y, x_new, marker_size, c=z, vmin=vmin, vmax=vmax,
                      cmap='viridis')
###
ax.set_xlim(-10,5)
ax.set_xlabel('$E - E_F$ (eV)')
ax.set_ylabel('$z$ ($\mathrm{\AA}$)')
